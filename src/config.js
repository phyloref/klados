...
export const OPEN_TREE_ABOUT_URL =
  "https://api.opentreeoflife.org/v3/tree_of_life/about";
...
export const OPEN_TREE_TNRS_MATCH_NAMES_URL =
...
export const OPEN_TREE_INDUCED_SUBTREE_URL =
...
export const COOKIE_DEFAULT_NOMEN_CODE_URI =
  "kladosDefaultNomenclaturalCodeURI";
// - curator name
